		...
		<div id="nav">
			<ul>
				<li class="upp"><a href="#">Main control</a>
					<ul>
						<li>&#8250; <a href="?page=read">Visit site</a></li>
						<li>&#8250; <a href="?page=input">Input Employee</a></li>
					</ul>
				</li>
	...
	<div id="content">
		<div id="sidebar">
			<div class="box">
				...
				<ul id="home">
					<li class="b1"><a class="icon view_page" href="?page=read">Visit site</a></li>
					<li class="b2"><a class="icon report" href="?page=input">Input Employee</a></li>
				</ul>
			</div>
