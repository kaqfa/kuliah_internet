	...
	<div id="content">
		<div id="sidebar">
			<div class="box">
				...
				<ul id="home">
					<li class="b1"><a class="icon view_page" href="javascript:void(0)" 
							onclick="loadPage('read.php')">Visit site</a></li>
					<li class="b2"><a class="icon report" href="javascript:void(0)" 
							onclick="loadPage('input.php')">Input Employee</a></li>
					<li class="b2"><a class="icon report" href="javascript:void(0)" 
							onclick="loadCustomer('customers.xml')">Customers File</a></li>
					<li class="b2"><a class="icon report" href="javascript:void(0)" 
							onclick="loadCustomer('backend.php')">Customers DB</a></li>
				</ul>
			</div>
