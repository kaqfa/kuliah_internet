...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="../demo/adminlte/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    ...
    <!-- iCheck -->
    <script src="../demo/adminlte/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
