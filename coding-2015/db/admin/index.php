      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
              ...
              <li><a href="index.php?page=input_matkul">Input Mata Kuliah</a></li>
              <li><a href="index.php?page=list_matkul">List Mata Kuliah</a></li>
            </ul>
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <?php
            ...
            if(isset($_GET['page']) &&
               ($_GET['page'] == 'input_matkul' || $_GET['page'] == 'edit_matkul'))
                include "form_matkul.php";
            elseif(isset($_GET['page']) && $_GET['page'] == 'list_matkul')
                include "list_matkul.php";
            else
